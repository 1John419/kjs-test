...
let appCaches = [
  {
    name: 'kjs-test-core-20200418.05.02',
    urls: [
      './',
      './bundle.js',
      './favicon.png',
  ...
  {
    name: 'kjs-test-font-20200207.01',
    urls: [
  ...
  {
    name: 'kjs-test-help-20200418.05',
    urls: [
      './help/about.html',
      './help/bookmark.html',
      './help/help.html',
  ...
  {
    name: 'kjs-test-json-20200418.01',
    urls: [
      './json/strong.json',
      './json/tome.kjv.json'
    ]
